...
sys.path.insert(0, os.path.abspath('../../enlp'))
...
project = 'eNLP'
copyright = '2018-{}, Claire Birnie'.format(year)

# Version
version = get_distribution('enlp').version
...
html_context = {
    ...
    'menu_links': [
        ('<i class="fa fa-github fa-fw"></i> Source Code', 'https://github.com/equinor/eNLP/'),
    ],
